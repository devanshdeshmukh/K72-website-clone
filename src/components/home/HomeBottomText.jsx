...
const HomeBottomText = () => {
  return (
    <div className='font-[font2] flex items-center justify-center gap-2'>
      <p className='absolute lg:w-[17vw] w-64 lg:right-20 right-0 bottom-28 text-xs lg:bottom-72 font-[font1]  lg:leading-relaxed leading-tight'>
      ...
      <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-22 flex items-center px-3 pb-2 lg:px-14 border-white rounded-full uppercase'>
